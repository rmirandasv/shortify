<div class="w-full p-4 flex flex-col bg-white rounded-md shadow">
    ...
    <div clsss="flex flex-col">
        <div class="flex justify-center">
            <a href="{{ route('login.google') }}" class="px-4 py-2 flex items-center space-x-2 border border-gray-400 bg-white hover:bg-gray-300 text-gray-800 rounded-2xl">
                ...
                <span class="ml-2 text-gray-800">Continue with Google</span>
            </a>
        </div>
    </div>
